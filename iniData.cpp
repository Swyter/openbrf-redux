...
public:
  ...
  char* stringT(int n){
    ...
    int k=sscanf(
      ...
      to[0x140],to[0x141],to[0x142],to[0x143],to[0x144],to[0x145],to[0x146],to[0x147],to[0x148],to[0x149],to[0x14A],to[0x14B],to[0x14C],to[0x14D],to[0x14E],to[0x14F],
      to[0x150],to[0x151],to[0x152],to[0x153],to[0x154],to[0x155],to[0x156],to[0x157],to[0x158],to[0x159],to[0x15A],to[0x15B],to[0x15C],to[0x15D],to[0x15E],to[0x15F],
      to[0x160],to[0x161],to[0x162],to[0x163],to[0x164],to[0x165],to[0x166],to[0x167],to[0x168],to[0x169],to[0x16A],to[0x16B],to[0x16C],to[0x16D],to[0x16E],to[0x16F],
      to[0x170],to[0x171],to[0x172],to[0x173],to[0x174],to[0x175],to[0x176],to[0x177],to[0x178],to[0x179],to[0x17A],to[0x17B],to[0x17C],to[0x17D],to[0x17E],to[0x17F],
      to[0x180],to[0x181],to[0x182],to[0x183],to[0x184],to[0x185],to[0x186],to[0x187],to[0x188],to[0x189],to[0x18A],to[0x18B],to[0x18C],to[0x18D],to[0x18E],to[0x18F],
      to[0x190],to[0x191],to[0x192],to[0x193],to[0x194],to[0x195],to[0x196],to[0x197],to[0x198],to[0x199],to[0x19A],to[0x19B],to[0x19C],to[0x19D],to[0x19E],to[0x19F],
      to[0x1A0],to[0x1A1],to[0x1A2],to[0x1A3],to[0x1A4],to[0x1A5],to[0x1A6],to[0x1A7],to[0x1A8],to[0x1A9],to[0x1AA],to[0x1AB],to[0x1AC],to[0x1AD],to[0x1AE],to[0x1AF],
      to[0x1B0],to[0x1B1],to[0x1B2],to[0x1B3],to[0x1B4],to[0x1B5],to[0x1B6],to[0x1B7],to[0x1B8],to[0x1B9],to[0x1BA],to[0x1BB],to[0x1BC],to[0x1BD],to[0x1BE],to[0x1BF],
      to[0x1C0],to[0x1C1],to[0x1C2],to[0x1C3],to[0x1C4],to[0x1C5],to[0x1C6],to[0x1C7],to[0x1C8],to[0x1C9],to[0x1CA],to[0x1CB],to[0x1CC],to[0x1CD],to[0x1CE],to[0x1CF],
      to[0x1D0],to[0x1D1],to[0x1D2],to[0x1D3],to[0x1D4],to[0x1D5],to[0x1D6],to[0x1D7],to[0x1D8],to[0x1D9],to[0x1DA],to[0x1DB],to[0x1DC],to[0x1DD],to[0x1DE],to[0x1DF],
      to[0x1E0],to[0x1E1],to[0x1E2],to[0x1E3],to[0x1E4],to[0x1E5],to[0x1E6],to[0x1E7],to[0x1E8],to[0x1E9],to[0x1EA],to[0x1EB],to[0x1EC],to[0x1ED],to[0x1EE],to[0x1EF],
      to[0x1F0],to[0x1F1],to[0x1F2],to[0x1F3],to[0x1F4],to[0x1F5],to[0x1F6],to[0x1F7],to[0x1F8],to[0x1F9],to[0x1FA],to[0x1FB],to[0x1FC],to[0x1FD],to[0x1FE],to[0x1FF]
    );
  ...
  uint tokenCount() {
    ...
    for (uint i = 0; data[i] != 0 || i >= sizeof(data); i++) { /* swy: for each character in the current line... */
...
bool IniData::readModuleTxts(const QString &pathMod, const QString& pathData){
...

  {
...

    {
      ...
      while (!tf.qf.atEnd()) { /* swy: there is not explicit line/element counter here in the first line, so just keep reading until exhausting them all */
        tf.nextLine();
        ...
        if (tf.tokenCount() >= 5 && QString(tf.stringT(5)).compare("none", Qt::CaseInsensitive) != 0)
